...
export default function Changetraits(props) {
    ...
    async function getCurrentTraits(id) {
        try {
            {console.log("getCurrentTraits called : ",id);}
            ...
            console.log("isChange : ",isChange[4].Ear.isFreezed);
            setEar(isChange[4].Ear.isFreezed)
            setNewHat(isChange[4].Hat.isFreezed)
            setNewHair(isChange[4].Hair.isFreezed)
            setNewJacket(isChange[4].Jacket.isFreezed)
            setNewNose(isChange[4].Nose.isFreezed)
            setNewglasse(isChange[4].Glass.isFreezed)
    ...
    async function getFreezedTraitsValue() {
        var config = {
            method: 'get',
            // url: `https://stg.knowlytes.com/api/api/setlayer`,
            // url: `https://stg.knowlytes.com/api/api/getfreezetraits`,
            url: `https://stg.knowlytes.com/api/getfreezetraits`
            // data: data,
        };
        axios(config)
    ...
    const setLayer = async (
        ...
        var config = {
            method: 'post',
            url: `${process.env.NEXT_PUBLIC_API_HOST_3001}/setlayer`,
            // url: `https://stg.knowlytes.com/api/api/setlayer`,
            data: data,
        };
        ...
        axios(config)
            .then(function (response) {
                ...
                setTimeout(() => {
                    ...
                    // fetch(`https://stg.knowlytes.com/api/assets/${tokenID}.gif`)
            ...
            try {
                ...
                if (typeof window !== undefined) {
                    ...
                    var config = {
                        method: 'post',
                        // url: `https://stg.knowlytes.com/api/api/setlayer`,
                        url: `${process.env.NEXT_PUBLIC_API_HOST_3001}/selectedmetadata`,
                        data: data,
                    };
        ...
        <div>
            ...
            {tokenID ?
                <div>
                    ...
                    <div className="container mt-3 Ncontainer">
                        ...
                        {isNFTChange ?
                            <div className="row">
                                        ...
                                        <>
                                            {gifloader ?
                                                ...
                                                <img
                                                    ...
                                                    // src={`https://stg.knowlytes.com/api/changeImage/${tokenID}.gif`}
                                ...
                                <div className="col-md-4 mt-3 text-center mx-auto">
                                    ...
                                    <img
                                        className="img-fluid rounded"
                                        // src={`https://stg.knowlytes.com/api/assets/${tokenID}.gif`}
