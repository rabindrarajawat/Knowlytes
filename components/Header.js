                ...
                {windowSize.innerWidth > 2000 ?
                    <div className="container">
                        <Link className={`navbar-brand `} href="/" >
                            ...
                            <Image src="/newlogo.svg" alt="Logo" width='200px' height='30px' className={`${styles.navCursor} `} />
                        </Link>
                        ...
                        <div className="collapse navbar-collapse" id="navbarCollapse">
                            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 ">
                                ...
                                <li className="nav-item">
                                    {router.pathname=='/'?
                                    <Link  href="#whiteList"><a className="nav-link active mx-3" onClick={()=>setCloseNav(!closeNav)}>Allow List</a></Link>
                                :
                                <Link  href="/#whiteList"><a className="nav-link active mx-3" onClick={()=>setCloseNav(!closeNav)}>Allow List</a></Link>
                }
                                    </li>
                                ...
                                <li className="nav-item">
                                    <Link href=" https://discord.gg/nzq4MYyp3Y"><a className="nav-link active mx-2" target="_blank"><FaDiscord style={{ height: 24, width: 24 }} /></a></Link>
                                </li>
                                ...
                                <li className="nav-item">
                                    ...
                                    <Link href="https://twitter.com/knowlytes">
                                        <a className="nav-link active mx-2" target="_blank">
                                            
                                            <AiOutlineTwitter style={{ height: 24, width: 24 }} />
                                        </a>
                                        </Link>
                                </li>
                                {/* <li className="nav-item">
                    ...
                    <div className="container-fluid">
                        <Link className="navbar-brand" href="/">
                            ...
                            <Image src="/NewLogo.png" alt="Logo" width={200} height={30} className={`${styles.navCursor} `} style={{ cursor: "pointer" }} />
                        </Link>
                        <button className="navbar-toggler" type="button" data-bs-toggle="collapse" onClick={()=>setCloseNav(!closeNav)} data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
                            <span className="navbar-toggler-icon"></span>
                        </button>
