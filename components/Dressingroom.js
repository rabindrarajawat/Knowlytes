...
export default function DressingRoom() {
  ...
  const setLayer = async (
    ...
    var Fhat = Phat
    console.log("🚀 ~ file: index.js ~ line 111 ~ Home ~ Fhat", Fhat)
    var Fhair = Phair
    var Fglasse = Pglasse
    var Fear = Pear
    var Fnose = Pnose
    ...
    console.log("🚀 ~ file: index.js ~ line 139 ~ Home ~ details", details.attributes[0].value)
  ...
  function setState(e) {
    console.log("🚀 ~ file: index.js ~ line 179 ~ setState ~ e", e)
